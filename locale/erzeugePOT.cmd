...
"%PROGRAMFILES(X86)%\Poedit\GettextTools\bin\xgettext.exe" -f potfile.txt --from-code=UTF-8 --language=PHP -k=T_gettext --keyword=T_ --keyword=_ --keyword=__ -o MArs.pot
